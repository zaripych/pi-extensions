 ...
 */
import { readdir, readlink, mkdir, lstat, stat, symlink, unlink } from "node:fs/promises";
...
const DEST = process.env.PI_EXTENSIONS_DIR ?? join(homedir(), ".pi", "agent", "extensions");
